...
There was a requirement to find out the mean of variables measured for different testing condition.
...
The mean of the following set of variables that were estimated from these signals are: 
